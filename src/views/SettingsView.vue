<template>
  <div class="min-h-screen bg-[#0d0d0d] text-[#f0f0f0]">
    ...
    <main class="max-w-4xl mx-auto px-4 py-6 space-y-6">
      <!-- 连接设置 -->
      <section class="bg-[#151515] rounded-xl border border-[#2a2a2a] p-6">
        ...
        <div class="space-y-4">
          <div>
            <label class="block text-sm text-[#909090] mb-2">WebSocket 地址</label>
            <input
              v-model="wsUrl"
              type="text"
          ...
          <div>
            <label class="block text-sm text-[#909090] mb-2">API 基础地址</label>
            <input
              v-model="apiBase"
              type="text"
          ...
          <div>
            <label class="block text-sm text-[#909090] mb-2">用户 ID</label>
            <input
              v-model="userId"
              type="text"
              placeholder="user-1"
      ...
      <section class="bg-[#151515] rounded-xl border border-[#2a2a2a] p-6">
        ...
        <div v-else-if="providers.length > 0" class="grid grid-cols-2 md:grid-cols-3 gap-3">
          <div
          ...
          >
            ...
            <div class="text-xs text-[#909090] mt-1">{{ provider.model }}</div>
          </div>
        </div>
      ...
      >
        <h2 class="text-lg font-medium mb-4 flex items-center gap-2">
          ...
          技能管理
          <ChevronRightIcon :size="20" class="ml-auto text-[#909090]" />
        </h2>
      ...
      <section class="bg-[#151515] rounded-xl border border-[#2a2a2a] p-6">
        ...
        <div class="space-y-3">
          <div class="flex items-center justify-between">
            ...
            <span :class="apiHealth === 'ok' ? 'text-green-500' : 'text-red-500'">
