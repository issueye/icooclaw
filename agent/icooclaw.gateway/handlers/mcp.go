...
func (h *MCPHandler) Page(w http.ResponseWriter, r *http.Request) {
	req, err := models.Bind[*storage.QueryMCPConfig](r)
	if err != nil {
	...
	configs, err := h.storage.MCPConfig().Page(req)
	if err != nil {
	...
	models.WriteData(w, models.BaseResponse[*storage.ResQueryMCPConfig]{
		Code:    http.StatusOK,
		Message: "MCP配置列表获取成功",
		Data:    configs,
	})
...
func (h *MCPHandler) Save(w http.ResponseWriter, r *http.Request) {
	...
	err = h.storage.MCPConfig().CreateOrUpdate(req)
	if err != nil {
...
func (h *MCPHandler) Create(w http.ResponseWriter, r *http.Request) {
	...
	err = h.storage.MCPConfig().Create(req)
	if err != nil {
...
func (h *MCPHandler) Update(w http.ResponseWriter, r *http.Request) {
	...
	err = h.storage.MCPConfig().Update(req)
	if err != nil {
...
func (h *MCPHandler) GetAll(w http.ResponseWriter, r *http.Request) {
	configs, err := h.storage.MCPConfig().GetAll()
	if err != nil {
