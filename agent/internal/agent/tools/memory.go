...
func (t *MemoryUpdateTool) Description() string {
	return `更新记忆文件的内容。用于设置AI名字、用户称呼等信息。

使用场景：
- 当用户告诉你AI的名字时，使用 file="soul", section="身份", content="你的名字是：XXX"
- 当用户告诉你如何称呼他时，使用 file="user", section="用户称呼", content="XXX"`
}
	...
	return map[string]interface{}{
		...
		"properties": map[string]interface{}{
			...
			"section": map[string]interface{}{
				"type":        "string",
				"description": "要更新的部分标题（如：身份、用户称呼）",
				"enum":        []string{"身份", "用户称呼"},
			},
